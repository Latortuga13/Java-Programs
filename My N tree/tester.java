...
public class tester {
     ...
     * if our tree contains null, for when we add to an empty tree, and for
     * when we check if the tree contains an element that does exit in the
     * tree. This test also checks if the tree works with a size other than
     * five, unlike the previous test cases.
     */
    @Test
