 ...
 * none
 * 
 * This is my ticket class. I wrote the compareTo method, and compared
 * the order values from the hasmap.
 */
...
public class Ticket implements Comparable<Ticket>{
    ...
    public int compareTo(Ticket other){
        int toReturn;
        //TODO: Your code
        if(orderMap.get(this.ticketType).equals(orderMap.get(other.ticketType))
         && this.createdAt.equals(other.createdAt)){
            toReturn=0;
        }
        else if(orderMap.get(this.ticketType)<orderMap.get(other.ticketType)){
            toReturn=-1;
        }
        else if(orderMap.get(this.ticketType)>orderMap.get(other.ticketType)){
            toReturn=1;
